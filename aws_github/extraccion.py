...
def extraer_datos_pccom_api():
    ...
    for page in range(1, 26):
        ...
        while not exito and intentos < 6: 
            url_api_change = f'https://www.pccomponentes.com/api/dynamic-view?url=https%3A%2F%2Fwww.pccomponentes.com%2Fcampanas%2Fofertas-especiales%3Fsort%3Ddiscount%26page%3D{page}'
            # %3Fsort%3Ddiscount%26p esto nos permite seleccionar 25 productos, sin esta parte no hace su trabajo
